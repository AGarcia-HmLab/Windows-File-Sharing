...
2. Created a New folder and named it "company files" in the main drive. Configured its setting by changing shared permissions to full control and NTFS permissions
## Comments/ notes
